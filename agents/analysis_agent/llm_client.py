...
Follows the same pattern as workspace_agent/llm_client.py.
"""
...
async def chat_completion_stream(
    ...
    Used for synthesis calls (tool_choice="none") where no tool calls are
    expected. Streaming reduces time-to-first-token for remote endpoints.
    ...
    stream = await llm_stream_with_retry(_open_stream, label="analysis_stream")
